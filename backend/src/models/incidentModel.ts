...
export const incidentArray: Incident[] = [
  {
    ...
    description: "Production database experiencing intermittent connection timeouts affecting user queries",
    ...
    aiAnalysis: {
      ...
      priority: "critical",
      recommendation: "Check connection pool settings and database server load. Consider scaling resources."
    }
  },
  {
    id: "incident-2",
    title: "API Rate Limit Exceeded",
    description: "Third-party API returning 429 errors due to rate limit being exceeded",
    status: "open",
    priority: "high",
    ...
    aiAnalysis: {
      ...
      priority: "high",
      recommendation: "Implement request throttling and caching strategy for API calls."
    }
  },
  {
    id: "incident-3",
  ...
  },
  {
    ...
    aiAnalysis: {
      type: "Frontend",
      priority: "low",
      recommendation: "CSS media query adjustment needed for responsive design."
    }
  }
];
